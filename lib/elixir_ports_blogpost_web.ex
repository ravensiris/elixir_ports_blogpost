defmodule ElixirPortsBlogpostWeb do
  @moduledoc """
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ElixirPortsBlogpostWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: ElixirPortsBlogpostWeb.Router,
        statics: ElixirPortsBlogpostWeb.static_paths()
    end
  end
